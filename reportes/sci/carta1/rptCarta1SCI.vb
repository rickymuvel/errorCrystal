...
Public Class rptCarta1SCI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptCarta1SCI.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_rptDetalles1SCIrpt_FECHA_IMPRESION() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCarta1SCI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCarta1SCI = New rptCarta1SCI()
        rpt.Site = Me.Site
        Return rpt
    End Function
