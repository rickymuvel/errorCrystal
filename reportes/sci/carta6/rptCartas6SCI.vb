...
Public Class rptCartas6SCI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptCartas6SCI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCartas6SCI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCartas6SCI = New rptCartas6SCI()
        rpt.Site = Me.Site
        Return rpt
    End Function
