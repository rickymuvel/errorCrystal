...
Public Class rptDetalles7SCI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptDetalles7SCI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetalles7SCI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalles7SCI = New rptDetalles7SCI()
        rpt.Site = Me.Site
        Return rpt
    End Function
