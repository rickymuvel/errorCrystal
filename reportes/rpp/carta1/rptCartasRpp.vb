...
Public Class rptCartasRpp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptCartasRpp.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_fecha_impresion() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCartasRpp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCartasRpp = New rptCartasRpp()
        rpt.Site = Me.Site
        Return rpt
    End Function
