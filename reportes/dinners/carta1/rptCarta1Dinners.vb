...
Public Class rptCarta1Dinners
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptCarta1Dinners.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCarta1Dinners
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCarta1Dinners = New rptCarta1Dinners()
        rpt.Site = Me.Site
        Return rpt
    End Function
