...
Public Class rptCarta3Finan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptCarta3Finan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCarta3Finan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCarta3Finan = New rptCarta3Finan()
        rpt.Site = Me.Site
        Return rpt
    End Function
