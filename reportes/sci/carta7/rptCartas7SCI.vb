...
Public Class rptCartas7SCI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptCartas7SCI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCartas7SCI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCartas7SCI = New rptCartas7SCI()
        rpt.Site = Me.Site
        Return rpt
    End Function
