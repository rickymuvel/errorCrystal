...
Public Class rptDetalles9SCI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptDetalles9SCI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetalles9SCI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalles9SCI = New rptDetalles9SCI()
        rpt.Site = Me.Site
        Return rpt
    End Function
