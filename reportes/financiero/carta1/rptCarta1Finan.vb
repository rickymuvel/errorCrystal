...
Public Class rptCarta1Finan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptCarta1Finan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCarta1Finan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCarta1Finan = New rptCarta1Finan()
        rpt.Site = Me.Site
        Return rpt
    End Function
