...
Public Class rptDetalles3Finan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptDetalles3Finan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetalles3Finan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalles3Finan = New rptDetalles3Finan()
        rpt.Site = Me.Site
        Return rpt
    End Function
