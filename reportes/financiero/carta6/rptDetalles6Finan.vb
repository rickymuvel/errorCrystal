...
Public Class rptDetalles6Finan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptDetalles6Finan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetalles6Finan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalles6Finan = New rptDetalles6Finan()
        rpt.Site = Me.Site
        Return rpt
    End Function
