...
Public Class rptCartas4SCI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptCartas4SCI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCartas4SCI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCartas4SCI = New rptCartas4SCI()
        rpt.Site = Me.Site
        Return rpt
    End Function
