...
Public Class rptCarta2Dinners
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptCarta2Dinners.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCarta2Dinners
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCarta2Dinners = New rptCarta2Dinners()
        rpt.Site = Me.Site
        Return rpt
    End Function
