...
Public Class rptCarta7Finan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptCarta7Finan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCarta7Finan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCarta7Finan = New rptCarta7Finan()
        rpt.Site = Me.Site
        Return rpt
    End Function
