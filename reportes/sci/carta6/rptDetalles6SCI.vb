...
Public Class rptDetalles6SCI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptDetalles6SCI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetalles6SCI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalles6SCI = New rptDetalles6SCI()
        rpt.Site = Me.Site
        Return rpt
    End Function
