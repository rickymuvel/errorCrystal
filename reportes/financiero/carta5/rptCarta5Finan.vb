...
Public Class rptCarta5Finan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptCarta5Finan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCarta5Finan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCarta5Finan = New rptCarta5Finan()
        rpt.Site = Me.Site
        Return rpt
    End Function
