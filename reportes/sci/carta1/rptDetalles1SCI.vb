...
Public Class rptDetalles1SCI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptDetalles1SCI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetalles1SCI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalles1SCI = New rptDetalles1SCI()
        rpt.Site = Me.Site
        Return rpt
    End Function
