...
Public Class rptDetalles2SCI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptDetalles2SCI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetalles2SCI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalles2SCI = New rptDetalles2SCI()
        rpt.Site = Me.Site
        Return rpt
    End Function
