...
Public Class rptCartas8SCI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptCartas8SCI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCartas8SCI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCartas8SCI = New rptCartas8SCI()
        rpt.Site = Me.Site
        Return rpt
    End Function
