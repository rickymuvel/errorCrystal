...
Public Class rptCartas5SCI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptCartas5SCI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCartas5SCI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCartas5SCI = New rptCartas5SCI()
        rpt.Site = Me.Site
        Return rpt
    End Function
