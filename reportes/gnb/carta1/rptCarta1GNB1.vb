...
Public Class rptCarta1GNB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptCarta1GNB.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_rptDetallesGNBrpt_fecha() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCarta1GNB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCarta1GNB = New rptCarta1GNB()
        rpt.Site = Me.Site
        Return rpt
    End Function
