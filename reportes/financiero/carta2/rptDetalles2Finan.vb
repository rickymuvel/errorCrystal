...
Public Class rptDetalles2Finan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptDetalles2Finan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetalles2Finan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalles2Finan = New rptDetalles2Finan()
        rpt.Site = Me.Site
        Return rpt
    End Function
