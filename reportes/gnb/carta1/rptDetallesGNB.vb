...
Public Class rptDetallesGNB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptDetallesGNB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetallesGNB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetallesGNB = New rptDetallesGNB()
        rpt.Site = Me.Site
        Return rpt
    End Function
