...
Public Class rptCarta6Finan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptCarta6Finan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCarta6Finan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCarta6Finan = New rptCarta6Finan()
        rpt.Site = Me.Site
        Return rpt
    End Function
