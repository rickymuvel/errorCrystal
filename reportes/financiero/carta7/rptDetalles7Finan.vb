...
Public Class rptDetalles7Finan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptDetalles7Finan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetalles7Finan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalles7Finan = New rptDetalles7Finan()
        rpt.Site = Me.Site
        Return rpt
    End Function
