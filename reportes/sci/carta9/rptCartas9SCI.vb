...
Public Class rptCartas9SCI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptCartas9SCI.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_N_de_carta() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Fecha_de_Carta() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCartas9SCI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCartas9SCI = New rptCartas9SCI()
        rpt.Site = Me.Site
        Return rpt
    End Function
