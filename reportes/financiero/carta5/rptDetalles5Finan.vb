...
Public Class rptDetalles5Finan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pruebas2.rptDetalles5Finan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetalles5Finan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalles5Finan = New rptDetalles5Finan()
        rpt.Site = Me.Site
        Return rpt
    End Function
